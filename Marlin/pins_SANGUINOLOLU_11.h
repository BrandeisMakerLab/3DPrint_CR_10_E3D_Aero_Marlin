...
#define HEATER_0_PIN       13 // (extruder)
  ...
  #define FAN_PIN           4 //THIS USED TO BE 4, I CHANGED IT BECAUSE I AM GABE (And so we could have it turn on when the hotend is hot, not blow all the time) Works for Panelolu2 too
#endif
